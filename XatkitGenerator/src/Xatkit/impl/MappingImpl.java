 ...
 * </p>
 * <ul>
 *   <li>{@link Xatkit.impl.MappingImpl#getEntries <em>Entries</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MappingImpl extends EntityImpl implements Mapping {
	...
	protected EClass eStaticClass() {
		return XatkitPackage.Literals.MAPPING;
	}
	...
	public EList<Entry> getEntries() {
		if (entries == null) {
			entries = new EObjectContainmentEList<Entry>(Entry.class, this, XatkitPackage.MAPPING__ENTRIES);
		}
		return entries;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case XatkitPackage.MAPPING__ENTRIES:
