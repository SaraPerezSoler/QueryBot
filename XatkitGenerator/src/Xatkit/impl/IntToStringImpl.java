 ...
 * </p>
 * <ul>
 *   <li>{@link Xatkit.impl.IntToStringImpl#getTypedKey <em>Key</em>}</li>
 *   <li>{@link Xatkit.impl.IntToStringImpl#getTypedValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntToStringImpl extends MinimalEObjectImpl.Container implements BasicEMap.Entry<Integer,String> {
	/**
	...
	protected EClass eStaticClass() {
		return XatkitPackage.Literals.INT_TO_STRING;
	}
	...
	public void setTypedValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XatkitPackage.INT_TO_STRING__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XatkitPackage.INT_TO_STRING__KEY:
				return getTypedKey();
			case XatkitPackage.INT_TO_STRING__VALUE:
