 ...
 * </p>
 * <ul>
 *   <li>{@link Xatkit.impl.ComplexEntryTokenImpl#getPos <em>Pos</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ComplexEntryTokenImpl extends MinimalEObjectImpl.Container implements ComplexEntryToken {
	/**
	...
	public void setPos(int newPos) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XatkitPackage.COMPLEX_ENTRY_TOKEN__POS, oldPos, pos));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XatkitPackage.COMPLEX_ENTRY_TOKEN__POS:
				return getPos();
		}
